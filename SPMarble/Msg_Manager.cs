...
public class Msg_Manager : MonoBehaviour {
	...
	private Image image; //utilizado para alterar as cores dos pads
	...
	void Start () {
		...
		image5 = GameObject.Find("ArrowLeft").GetComponent<Image>();
	...
	void Update () {
		...
		if (timer3&&(countClick==3)) {
			...
			//Ativa a mensagem 4 segundos após o click em Ok da mensagem anterior
			if (Time.time - eventTimeTrigger2 >= 3.0f) {
